...
char* testfile =
    "../tests/wintrospection-tests/wow64/snapshots/wow64_precalcwin7sp0.tar.gz";
char* dlllistfile =
    "../tests/wintrospection-tests/wow64/dlllist/wow64_precalcwin7sp0_dlllist.json";
...
std::map<uint64_t, std::vector<struct ModuleInfo>> WOW64_EXPECTED_RESULTS = {
    {2688,
     {{0x00400000, 0x0002d000, 0x0000ffff,
       "C:\\Users\\lisa\\Desktop\\preccalc-32bit\\preccalc.exe"},
      ...
      {0x766c0000, 0x00084000, 0x0000ffff,
       "C:\\Windows\\WinSxS\\x86_microsoft.windows.common-controls_6595b64144ccf1df_5.82."
       "7600.16385_none_ebf82fc36c758ad5\\COMCTL32.dll"},
      ...
      {0x746d0000, 0x0019e000, 0x00000001,
       "C:\\Windows\\WinSxS\\x86_microsoft.windows.common-controls_6595b64144ccf1df_6.0."
       "7600.16385_none_421189da2b7fabfc\\comctl32.DLL"},
