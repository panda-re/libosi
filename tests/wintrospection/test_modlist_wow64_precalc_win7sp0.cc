...
char* testfile = "../tests/wintrospection-tests/wow64/snapshots/wow64_precalcwin7sp0.tar.gz";
char* dlllistfile = "../tests/wintrospection-tests/wow64/dlllist/wow64_precalcwin7sp0_dlllist.json";
...
std::map<uint64_t, std::vector<struct ModuleInfo>>  WOW64_EXPECTED_RESULTS = {
  {   2688, {
    ...
    {0x771b0000, 0x00180000, 0x0000ffff, "C:\\Windows\\SysWOW64\\ntdll.dll"},
    {0x76890000, 0x00100000, 0x0000ffff, "C:\\Windows\\syswow64\\kernel32.dll"},
    {0x753e0000, 0x00046000, 0x0000ffff, "C:\\Windows\\syswow64\\KERNELBASE.dll"},
    {0x74a60000, 0x00009000, 0x0000ffff, "C:\\Windows\\system32\\VERSION.dll"},
    {0x76750000, 0x000ac000, 0x0000ffff, "C:\\Windows\\syswow64\\msvcrt.dll"},
    {0x76390000, 0x00100000, 0x0000ffff, "C:\\Windows\\syswow64\\USER32.dll"},
    {0x751f0000, 0x00090000, 0x0000ffff, "C:\\Windows\\syswow64\\GDI32.dll"},
    {0x77180000, 0x0000a000, 0x0000ffff, "C:\\Windows\\syswow64\\LPK.dll"},
    {0x75310000, 0x0009d000, 0x0000ffff, "C:\\Windows\\syswow64\\USP10.dll"},
    {0x75440000, 0x000a0000, 0x0000ffff, "C:\\Windows\\syswow64\\ADVAPI32.dll"},
    {0x76c30000, 0x00019000, 0x0000ffff, "C:\\Windows\\SysWOW64\\sechost.dll"},
    {0x75620000, 0x000f0000, 0x0000ffff, "C:\\Windows\\syswow64\\RPCRT4.dll"},
    {0x74d20000, 0x00060000, 0x0000ffff, "C:\\Windows\\syswow64\\SspiCli.dll"},
    {0x74d10000, 0x0000c000, 0x0000ffff, "C:\\Windows\\syswow64\\CRYPTBASE.dll"},
    {0x754e0000, 0x0007b000, 0x0000ffff, "C:\\Windows\\syswow64\\comdlg32.dll"},
    {0x75180000, 0x00057000, 0x0000ffff, "C:\\Windows\\syswow64\\SHLWAPI.dll"},
    {0x766c0000, 0x00084000, 0x0000ffff, "C:\\Windows\\WinSxS\\x86_microsoft.windows.common-controls_6595b64144ccf1df_5.82.7600.16385_none_ebf82fc36c758ad5\\COMCTL32.dll"},
    {0x75710000, 0x00c49000, 0x0000ffff, "C:\\Windows\\syswow64\\SHELL32.dll"},
    {0x74dd0000, 0x00060000, 0x00000004, "C:\\Windows\\system32\\IMM32.DLL"},
    {0x765b0000, 0x000cc000, 0x00000002, "C:\\Windows\\syswow64\\MSCTF.dll"},
    {0x748f0000, 0x00080000, 0x00000003, "C:\\Windows\\system32\\uxtheme.dll"},
    {0x74870000, 0x00076000, 0x00000001, "C:\\Windows\\system32\\riched20.dll"},
    {0x74a20000, 0x00013000, 0x00000001, "C:\\Windows\\system32\\dwmapi.dll"},
    {0x746d0000, 0x0019e000, 0x00000001, "C:\\Windows\\WinSxS\\x86_microsoft.windows.common-controls_6595b64144ccf1df_6.0.7600.16385_none_421189da2b7fabfc\\comctl32.DLL"},
    {0x76c50000, 0x0015c000, 0x00000002, "C:\\Windows\\syswow64\\ole32.dll"}
  }} 
};
...
TEST(TestWOW64precalcPlist, Win7SP0amd64)
{
    ...
    kdetails.kpcr = 0xfffff80002bf8d00;
    kdetails.kdbg = 0xf80002bf7070;
    ...
    if ( process == nullptr)
        ...
        for (process; process != nullptr; process = process_list_next(plist)) {
            numProc++;
            if (process_get_pid(process) == 2688 )
